            ...
            <div className="relative bg-[#F0EFF4] py-24">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-lg max-w-3xl">
                        Get in touch with our team for research collaborations,
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        General: contact@sipr.org
                                        <br />
                                        Media: media@sipr.org
                                        <br />
                    ...
                    <div className="bg-[#F0EFF4] p-8 ">
                        ...
                        >
                            <div>
                                <label
                                    htmlFor="name"
                                    className="block font-['Montserrat'] text-sm font-medium text-gray-700 mb-1"
                                >
                                    Name
                                </label>
                                <input
                                    ...
                                    id="name"
                                    {...register("name")}
                                    className="w-full px-4 py-2 border border-gray-300  focus:outline-none focus:ring-2 focus:ring-[#8c1616] focus:border-transparent"
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center px-6 py-3 bg-[#8c1616] text-white  hover:bg-[#7a1313] transition-colors font-['Montserrat'] disabled:opacity-50 disabled:cursor-not-allowed"
                            >
