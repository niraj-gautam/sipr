    ...
    const events = [
        {
            ...
            type: "Conference",
            description:
                "Join leading policy experts and researchers for our annual summit on global policy challenges.",
        ...
        },
        {
            ...
            type: "Workshop",
            description:
                "An interactive session on emerging AI policies and their implications for governance.",
        ...
        },
        {
            ...
            type: "Symposium",
            description:
                "Exploring innovative approaches to sustainable rural development.",
        ...
        },
        {
            ...
            type: "Forum",
            description:
                "Discussing emerging trends and challenges in international trade policy.",
            ...
            <div className="relative bg-black text-gray-50 py-24">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-lg  max-w-3xl">
                        Join us for insightful discussions, workshops, and
                        conferences on critical policy issues.
                    </p>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {events.map((event, index) => (
                            <div
                                key={index}
                                className="bg-gray-50  overflow-hidden hover:shadow-md transition-shadow shadow-sm"
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <button className="px-4 py-2 bg-[#8c1616] text-white  hover:bg-[#7a1313] transition-colors font-['Montserrat']">
                                            Register
                                        </button>
                                    </div>
                                </div>
