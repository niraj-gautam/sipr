            ...
            partners: [
                {
                    ...
                    description:
                        "Collaborative research on AI policy and governance",
                    image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80",
                },
                {
                    name: "Oxford University",
                    description:
                        "Joint programs in economic development studies",
            ...
            partners: [
                {
                    name: "World Bank",
                    description:
                        "Research partnership on development economics",
            ...
            <div className="relative bg-black text-gray-50 py-24">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-lg  max-w-3xl">
                        Working together with leading institutions and
                        organizations to drive impactful policy research and
                        implementation.
                    </p>
                </div>
            </div>
                                ...
                                {category.partners.map((partner, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="p-6">
                                            ...
                                            <a
                                                href={`/partnerships/${partner.name
                                                    .toLowerCase()
                                                    .replace(/\s+/g, "-")}`}
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className=" text-gray-600 mb-8">
                            Join our network of partners and contribute to
                            shaping the future of policy research and
                            implementation.
                        </p>
                        <a
                            href="/contact"
