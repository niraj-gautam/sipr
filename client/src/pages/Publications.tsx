    ...
    const publications = [
        {
            ...
            abstract:
                "An analysis of how artificial intelligence is reshaping the landscape of public policy development and implementation.",
        ...
        },
        {
            ...
            abstract:
                "Examining the intersection of digital technologies and rural development strategies in emerging economies.",
        ...
        },
        {
            ...
            abstract:
                "A comprehensive analysis of changing global trade patterns and their implications for economic development.",
        ...
        },
        {
            ...
            abstract:
                "Studying recent urban migration patterns and their impact on city development and policy.",
            ...
            <div className="relative bg-[#F0EFF4] py-24">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-lg max-w-3xl">
                        Access our latest research papers, policy briefs, and
                        reports on critical policy issues.
                    </p>
                </div>
            </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {categories.map((category, index) => (
                                <button
                                    key={index}
                                    className={`px-4 py-2  text-sm font-['Montserrat'] ${
                                        index === 0
                                ...
                                <div className="flex flex-col md:flex-row md:items-start gap-6">
                                    <div className="flex-1">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <span className="inline-block bg-[#8c1616] text-white text-sm px-3 py-1 font-['Montserrat'] mb-2">
                                                    {pub.category}
                                                </span>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <a
                                            href={pub.link}
                                            className="inline-flex items-center justify-center px-4 py-2 bg-[#8c1616] text-white hover:bg-[#7a1313] transition-colors font-['Montserrat']"
                                        >
                                        ...
                                        <a
                                            ...
                                            className="inline-flex items-center justify-center px-4 py-2 border border-[#8c1616] text-[#8c1616]  hover:bg-[#8c1616] hover:text-white transition-colors font-['Montserrat']"
                                        >
                                            Read More
