    ...
    const results = [
        {
            ...
            description:
                "An analysis of how artificial intelligence is reshaping the landscape of public policy development...",
        ...
        },
        {
            ...
            description:
                "The Sankhya Institute announces a groundbreaking research program focused on artificial intelligence...",
                ...
                {results.length > 0 ? (
                    <div className="space-y-8">
                        {results.map((result, index) => (
                            <div key={index} className="bg-[#F0EFF4] p-6 ">
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600">
                            We couldn't find any matches for "{query}". Please
