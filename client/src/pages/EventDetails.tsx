        ...
        schedule: [
            {
                ...
                events: [
                    ...
                    {
                        time: "10:00 AM",
                        title: "Keynote Speech: Future of Policy Making",
                    },
                    {
                        time: "2:00 PM",
                        title: "Panel Discussion: AI in Governance",
                    },
                ],
            },
            {
                ...
                events: [
                    {
                        time: "9:30 AM",
                        title: "Workshop: Policy Implementation",
                    },
            ...
            <div className="relative h-96">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-white">
                        ...
                        <span className="inline-block bg-[#8c1616] px-4 py-2  text-sm font-['Montserrat']">
                            {event.type}
                        </span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <div className="prose max-w-none">
                            ...
                            <h2 className="text-2xl font-['Montserrat'] font-semibold mt-8 mb-6">
                                Speakers
                            </h2>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-[#F0EFF4] p-6  sticky top-8">
                            ...
                            <button className="w-full mt-8 px-6 py-3 bg-[#8c1616] text-white  hover:bg-[#7a1313] transition-colors font-['Montserrat']">
                                Register Now
                            </button>
                        </div>
                    </div>
