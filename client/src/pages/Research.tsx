    ...
    const areas = [
        {
            ...
            description:
                "Exploring the implications of artificial intelligence and data governance on society and policy.",
            projects: [
        ...
        },
        {
            ...
            description:
                "Analyzing fiscal policies and their impact on economic growth and social welfare.",
            projects: [
        ...
        },
        {
            ...
            description:
                "Studying population movements and urban development challenges in modern societies.",
            projects: [
        ...
        },
        {
            ...
            description:
                "Researching sustainable agricultural practices and rural economic growth.",
            projects: [
        ...
        },
        {
            ...
            description:
                "Examining international trade patterns and their effects on economic development.",
            projects: [
            ...
            <div className="relative bg-black text-gray-50 py-24">
                ...
                <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-lg  max-w-3xl">
                        Our research programs focus on critical policy
                        challenges facing society today, combining rigorous
                        analysis with practical solutions.
                    </p>
                </div>
            </div>
                        ...
                        {[
                            {
                                ...
                                description:
                                    "Identifying critical policy challenges through stakeholder engagement.",
                            },
                            {
                                step: "02",
                                title: "Data Collection",
                                description:
                                    "Gathering comprehensive data through various research methodologies.",
                            },
                            {
                                step: "03",
                                title: "Analysis",
                                description:
                                    "Rigorous analysis using advanced research tools and methodologies.",
                            },
                            {
                                step: "04",
                                title: "Policy Recommendations",
                                description:
                                    "Developing actionable policy recommendations based on research findings.",
                            },
                        ].map((item, index) => (
